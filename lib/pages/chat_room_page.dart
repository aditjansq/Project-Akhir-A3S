...
class _ChatRoomPageState extends State<ChatRoomPage> {  
  ...
  void initState() {  
    super.initState();  
    _loadMessages(); // Memuat pesan saat halaman diinisialisasi  
  }  
  
  Future<void> _loadMessages() async {  
    final prefs = await SharedPreferences.getInstance();  
    final String? storedMessages = prefs.getString('messages_${widget.catName}');  
  ...
  void _sendMessage(String sender, String text) {  
    ...
    _saveMessages(); // Simpan pesan setelah menambahkannya  
  }  
